...
namespace {
struct qt_meta_tag_ZN14TriangleDialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN14TriangleDialogE = QtMocHelpers::stringData(
    "TriangleDialog",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14TriangleDialogE[] = {
...
Q_CONSTINIT const QMetaObject TriangleDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14TriangleDialogE.offsetsAndSizes,
    qt_meta_data_ZN14TriangleDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14TriangleDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *TriangleDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14TriangleDialogE.stringdata0))
